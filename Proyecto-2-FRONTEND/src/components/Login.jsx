      ...
      <div className="login-form bg-white p-8 rounded-xl shadow-lg w-96 transform transition-all hover:scale-[1.01]">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="text-center mt-3">
            <small className="text-sm muted">¿No tienes cuenta?</small>
            <button
              type="button"
              onClick={() => { try { window.history.pushState({}, '', '/register'); window.dispatchEvent(new PopStateEvent('popstate')); } catch (e){} }}
